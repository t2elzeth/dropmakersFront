  ...
  return (
      <>
        <section className='access-control container'>
          ...
          <p className='text'>
            Here you can configure limited access for your account managers and other users you want to provide access
            to your account. For more information please refer to the following article Setting up limited access to
            your account
          </p>
